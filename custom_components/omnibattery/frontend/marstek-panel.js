...
const SYS_HELP = {
  en: {
    ...
    excluded_device_dynamic_power_control: "For devices that dynamically adjust their own demand using a grid meter. Requires Solar Surplus. Battery charging yields briefly so the device can react first; short pauses are held for 5 minutes and genuine leftover export may still charge the battery.",
  ...
  es: {
    ...
    excluded_device_dynamic_power_control: "Para dispositivos que ajustan dinámicamente su demanda mediante un contador de red. Requiere Excedente Solar. La carga de batería cede brevemente para que el dispositivo reaccione primero; las pausas breves se mantienen 5 minutos y el excedente sobrante real aún puede cargar la batería.",
  ...
  ca: {
    ...
    excluded_device_dynamic_power_control: "Per a dispositius que ajusten dinàmicament la seva demanda mitjançant un comptador de xarxa. Requereix Excedent Solar. La càrrega de la bateria cedeix breument perquè el dispositiu reaccioni primer; les pauses breus es mantenen 5 minuts i l'excedent sobrant real encara pot carregar la bateria.",
  ...
  de: {
    ...
    excluded_device_dynamic_power_control: "Für Geräte, die ihren Bedarf über einen Netzzähler dynamisch regeln. Benötigt Solarüberschuss. Die Batterieladung gibt kurz Vorrang, damit das Gerät zuerst reagieren kann; kurze Pausen werden 5 Minuten gehalten und echter Restüberschuss kann weiterhin die Batterie laden.",
  ...
  fr: {
    ...
    excluded_device_dynamic_power_control: "Pour les appareils qui ajustent dynamiquement leur demande à partir d'un compteur réseau. Nécessite Surplus Solaire. La charge de la batterie cède brièvement afin que l'appareil réagisse en premier ; les courtes pauses sont maintenues 5 minutes et le véritable surplus restant peut encore charger la batterie.",
  ...
  nl: {
    ...
    excluded_device_dynamic_power_control: "Voor apparaten die hun vraag dynamisch via een netmeter regelen. Vereist Zonne-overschot. Het laden van de batterij maakt kort plaats zodat het apparaat eerst kan reageren; korte pauzes worden 5 minuten vastgehouden en echt resterend overschot kan de batterij nog steeds laden.",
